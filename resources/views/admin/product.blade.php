                        ...
                        <div class = dive_center>
                            ...
                            <form action="{{url('/add_product')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="div_design">
                                    ...
                                    <input class= "text_color" type="text"  name="producttitle" placeholder="Write a title" required/>
                                </div>
                                ...
                                <div class="div_design">
                                    ...
                                    <input class= "text_color" type="text"  name="dis_price" placeholder="Write the discount" />
                                </div>
